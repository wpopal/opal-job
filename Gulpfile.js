...
gulp.task( 'watch', [ 'babel-admin-opaljob-frontend' ], function(){
    gulp.watch([
        path.join(folderPlugin, 'src/js/frontend/*.js'),
        path.join(folderPlugin, 'src/js/admin/*.js'),
        path.join(folderPlugin, 'src/sass/*.scss'),
        path.join(folderPlugin, 'src/sass/**/*.scss'),
          path.join(folderPlugin, 'src/sass/**/**/*.scss')
    ], () => {
...
gulp.task( 'opaljob-frontend', function() {
    return gulp.src(  path.join(folderPlugin, 'src/sass/**/*.scss')  )
...
gulp.task('babel-admin-opaljob-frontend', function () {
    return gulp.src([
