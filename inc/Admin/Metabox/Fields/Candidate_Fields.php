...
class Candidate_Fields extends User_Fields {
	...
	public  function get_fields() {
		...
		$settings = [
			 ...
			 * Social Fields Settings
			 */
			'cv_field_options'    => apply_filters( 'opaljob_cv_field_options', [
				'id'        => 'cv_field_options',
				'title'     => esc_html__( 'CV and Cover Letter', 'opaljob' ),
				'icon-html' => '<span class="fa fa-file"></span>',
				'fields'    =>  $this->get_cv_fields()
			] ),
		...
		return apply_filters( "opaljob_admin_candidate_fields_options", $settings );
	}	
