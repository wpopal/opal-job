...
?>
<div class="opaljob-group-field-wrap opaljob-repeatable-field-section <?php echo esc_attr( $wrapper_class ); ?>" data-field="<?php echo "{$args['id']}"; ?>" id="<?php echo "{$args['id']}_field"; ?>"
	...
	<?php if ( ! empty( $args['name'] ) ) : ?>
        <p class="opaljob-repeater-field-name"><?php echo trim( $args['name'] ); ?></p>
	<?php endif; ?>
	
	<?php if ( ! empty( $args['description'] ) ) : ?> 
        <p class="opaljob-repeater-field-description"><?php echo esc_html( $args['description'] ); ?></p>
	<?php endif; ?>
    ...
    <table class="opaljob-repeatable-fields-section-wrapper" cellspacing="0">
        ...
        <tr class="opaljob-template">
            <td class="opaljob-repeater-field-wrap opaljob-column" colspan="2">
                <div class="opal-row-head opaljob-move">
                    ...
                    <div class="button-action-group">
                    	<span class="opaljob-remove button-action" title="<?php esc_attr_e( 'Remove Group', 'opaljob' ); ?>">
                ...
                <div class="opal-row-body"><div class="opal-row">
        ...
        <tr>
			...
			$add_row_btn_title = isset( $args['options']['add_button'] )
				...
				: esc_html__( 'Add Row', 'opaljob' );
			?>
            <td colspan="2" class="opaljob-add-repeater-field-section-row-wrap">
