...
?>
    ...
    <div class="js-opaljob-metabox-wrap metabox-panel-wrap">
        <div class="opaljob-tab opaljob-tab-verticle">
            <ul class="opaljob-form-data-inline-tabs opaljob-metabox-inline-tabs job-tab-head ">
                        ...
                        <a href="#<?php echo $form_data_tab['id']; ?>"
                           data-tab-id="<?php echo $form_data_tab['id']; ?>">
                            ...
                            <?php else : ?>
                                <span class="opaljob-icon opaljob-icon-default"></span>
                            <?php endif; ?>
                            <span class="opaljob-label"><?php echo $setting['title']; ?></span>
                        </a>
                     </div>
                ...
                <?php if ( $this->has_sub_tab( $setting ) ) : ?>
                    <?php if ( ! empty( $setting['sub-fields'] ) ) : ?>
                        <?php foreach ( $setting['sub-fields'] as $index => $sub_fields ) : ?>
                            <div id="<?php echo $sub_fields['id']; ?>" class="panel opaljob_options_panel opaljob-hidden opaljob-panel">
