...
class Facebook_Login {
	...
	public function __construct() {
		...
		$this->facebook_secret = opaljob_get_option( 'facebook_secret', '' );

		$this->includes();

		add_action( 'query_vars', [ $this, 'add_query_vars' ] );
		add_action( 'parse_request', [ $this, 'process' ] );
		add_action( 'wp_ajax_opaljob_ajax_redirect_facebook_login_link', [ $this, 'ajax_redirect_facebook_login_link' ] );
		add_action( 'wp_ajax_nopriv_opaljob_ajax_redirect_facebook_login_link', [ $this, 'ajax_redirect_facebook_login_link' ] );
	}
	...
	public function ajax_redirect_facebook_login_link() {
		if ( 'off' === opaljob_get_option( 'enable_facebook_login' ) ) {
	...
	public function login() {
		...
		if ( ! is_user_logged_in() ) {
			...
			if ( $ID ) {
				 ...
				 */
				do_action( 'opaljob_after_create_facebook_user_new_email', $user_id );
