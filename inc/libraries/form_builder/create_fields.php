...
class Create_Fields {
						...
						switch ( $value ) {
							...
							case 'select':
								...
								if ( isset( $_POST['select_options_default'][ $case_select ] ) ) {
									$def_value_index = (int) $_POST['select_options_default'][ $case_select ];
								} else {
									$def_value_index = 0;
								}
	...
	public function render() {
		wp_enqueue_style( 'opaljob-form-builder', plugin_dir_url( __FILE__ ) . 'assets/css/form-builder.css', [], '1.0' );
		wp_enqueue_script( 'opaljob-form-builder', plugin_dir_url( __FILE__ ) . 'assets/js/form-builder.js', [ 'jquery' ], '1.0', false );
