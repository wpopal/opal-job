...
class User_Fields {
	...
	public function get_change_password_fields() {
		return [
			[
				'id'          => 'oldpassword',
				'name'        => esc_html__( 'Old Password', 'opaljob' ),
				'type'        => 'password',
				'required'    => true,
				'description' => esc_html__( 'Please enter your old password', 'opaljob' ),
			],
			[
				'id'          => 'new_password',
				'name'        => esc_html__( 'New Password', 'opaljob' ),
				'type'        => 'password',
				'required'    => true,
				'description' => esc_html__( 'Please enter your new password.', 'opaljob' ),
			],
			[
				'id'          => 'confirm_password',
				'name'        => esc_html__( 'Confirm Password', 'opaljob' ),
				'type'        => 'password',
				'required'    => true,
				'description' => esc_html__( 'Please enter your confirm password.', 'opaljob' ),
			],
		];
	}
}
