    ...
    function opaljob_uploader() {
        ...
        function check_number_files( file , i   ) {
            if( is_image_file(file) ) {
                if( i+1 > opaljobJS.mfile_image ){
                    return false; 
                }
            } else {
                if( i+1 > opaljobJS.mfile_other ){
                    return false; 
                }
            }
            return true; 
        ...
        function check_filesize (  file , i  ) {
            ...
            if( is_image_file(file) ) {
                if( file.size > opaljobJS.size_image ){
                    var myToast = $.toast({
                        heading: file.name,
                        text: opaljobJS.error_upload_size,
                        icon: 'error',
        ...
        function trigger_button_upload(){
              ...
              //  var all_selected = [];
               ...
               file_btn.on("change", function( event ){
                ...
                $( _container ).on( "click", ".btn-close", function(){
                    if( confirm(opaljobJS.confirmed ) ){
            ...
            $(".opaljob-uploader-files").each( function(){
                handleUpload( this )
            } );
